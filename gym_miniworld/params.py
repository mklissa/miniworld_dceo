...
DEFAULT_PARAMS.set('forward_step', 0.27, 0.27, 0.27)
...
DEFAULT_PARAMS.set('cam_pitch', 0)
DEFAULT_PARAMS.set('cam_fov_y', 60)
DEFAULT_PARAMS.set('cam_height', 1.5)
DEFAULT_PARAMS.set('cam_fwd_disp', 0)
